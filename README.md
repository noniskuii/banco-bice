<!DOCTYPE html>
<!-- saved from url=(0463)login.php-->
<html ng-app="WebBancoChile" ng-controller="AppCtrl" style="" class="js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths ng-scope"><!-- HTML header with browser directives --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="./Banco de Chile_files/js"></script><script type="text/javascript" async="" src="./Banco de Chile_files/destination"></script><script type="text/javascript" async="" src="./Banco de Chile_files/js(1)"></script><script async="" src="./Banco de Chile_files/gtm.js.descarga"></script><script src="./Banco de Chile_files/liest-prested-the-comes-Gread-then-be-my-spirity" async=""></script>
  
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
  <meta name="google-site-verification" content="3R23znnKdajn_7Gs69oO5F02vjpJER_X_pzax6btao0">
  <link rel="shortcut icon" href="https://portales.bancochile.cl/uploads/000/000/015/3328d923-73b6-4acd-a87f-65526e65ba78/C32x32/favicon.ico">
    ...
    <!-- compiled CSS -->
    <link rel="stylesheet" type="text/css" href="./Banco de Chile_files/cl.bancochile.canales.web-0.0.1-part-1.min.cea09c7074.css">
    <link rel="stylesheet" type="text/css" href="./Banco de Chile_files/cl.bancochile.canales.web-0.0.1-part-2.min.fd8862a6cc.css">
    <link rel="stylesheet" type="text/css" href="./Banco de Chile_files/cl.bancochile.canales.web-0.0.1-part-3.min.acbf7da162.css">
    <link rel="stylesheet" type="text/css" href="./Banco de Chile_files/cl.bancochile.canales.web-0.0.1-part-4.min.53795650e3.css">
    <link rel="stylesheet" type="text/css" href="./Banco de Chile_files/cl.bancochile.canales.web-0.0.1-part-5.min.576033ec94.css">
    <link rel="stylesheet" type="text/css" href="./Banco de Chile_files/cl.bancochile.canales.web-0.0.1-part-6.min.e3bca3246a.css">
    <link rel="stylesheet" href="./Banco de Chile_files/slick-theme.css" integrity="sha512-6lLUdeQ5uheMFbWm3CP271l14RsX1xtx+J5x2yeIDkkiBpeVTNhTqijME7GgRKKi6hCqovwCoBTlRBEC20M8Mg==" crossorigin="anonymous" referrerpolicy="no-referrer">
...
ra&&"10277231024135831"<ra+""?window.console.log("[CookiePrefix/initConfig] Min agent version detected, and javascript agent is older - the javascript agent will not be initialized!"):(ra=(La={},La.cfg="app=b36d2e3445d993b2|cors=1|featureHash=A27NVfghqrux|vcv=2|xb=www^bs.google-analytics^bs.com.*^p.*doubleclick.*^p.*google.*)^p.*obrareq.cgi.*^p.*obrar.cgi.*^p*pingrest.*|nsfnv=1|reportUrl=https://bf23391znv.bf.dynatrace.com/bf|rdnt=1|uxrgce=1|bp=3|cuc=kvhu7g9y|mel=100000|expw=1|md=mdcc1=bwindow.PUID|ssv=4|lastModification=1698249568508|tp=500,50,0,1|featureHash=A27NVfghqrux|agentUri=https://js-cdn.dynatrace.com/jstag/161f5a57e21/ruxitagent_A27NVfghqrux_10277231024135831.js|auto=|domain=|rid=RID_|rpid=|app=b36d2e3445d993b2",La.iCE=Wa,La.platformCookieOffset=null===Ra||void 0===Ra?void 0:Ra.platformCookieOffset,La),Sa&&(ra.platformPrefix=Sa),Ya.dT_=ra)}}}this.dT_&&dT_.prm&&dT_.prm();var Ya="undefined"!==typeof window?window:self,
...
r,w;if(!(11>document.documentMode)){var W=0>(null===(r=navigator.userAgent)||void 0===r?void 0:r.indexOf("RuxitSynthetic"));if(!Ka.dT_||!Ka.dT_.cfg||"string"!==typeof Ka.dT_.cfg||"initialized"in Ka.dT_&&Ka.dT_.initialized)(null===(w=Ka.dT_)||void 0===w?0:w.gCP)?Ve("[CookiePrefix/initCode] initCode with cookie prefix already initialized, not initializing initCode!"):Ve("InitConfig not found or agent already initialized! This is an injection issue."),Ka.dT_&&(Ka.dT_.di=3);else if(W)try{Gd();var H;Sd=
        ...
        rutFormateado += "-" + dv;
        if(rut.length > 0){
          document.getElementById("iduserName").value =  rutFormateado;
          if(validarRut(rutFormateado)){
            rutPaso = rut;
            contErrorIntento = 0;
            var rutAux = rut.replace("K", "0").replace("k", "0");
            if(rutAux > rut50MM){
            		mostrarErrorRut(ERROR_RUT_EMPRESA);
            }else{
            	rutCorrecto = true;
              casillaRut.style.borderColor = "#d2d2d4";
            }
          }else{
            mostrarErrorRut(ERROR_RUT_INVALIDO);
          }
        } else{
        	casillaRut.style.borderColor = "#d2d2d4";
        }
      ...
      function validarRut(rut) {
         ...
         // Separar el Rut en dígito verificador y cuerpo del Rut
         ...
         // Validar que el dígito verificador ingresado coincida con el esperado
         return dv == dvEsperado;
      }

      function mostrarErrorRut(value){
        rutCorrecto = false;
        var errorMessage = document.getElementById('errorRut');
        errorMessage.innerHTML = value;
        errorMessage.style.display = 'inline';
      }

      function limpiarMensajeError(value){
        var errorMessage = document.getElementById(value);
        errorMessage.style.display = 'none';
      }

      function pintarCasillaRut(){
     		  var iduserName = document.getElementById("iduserName").value;
          var casillaRut = document.getElementById("iduserName");

        	if(iduserName.length > 0){

            casillaRut.style.borderColor = "#f45516";

            var rutSinEspacio = iduserName.replace(/\s/g,"");
            if(rutSinEspacio.length === 0){
              	mostrarErrorRut(ERROR_RUT_VACIO);
            }
            var rutSinEspacioNiletras =  rutSinEspacio.replace(/[^\dKk]/g, "");
            if(validarRut(rutSinEspacioNiletras)){
               casillaRut.style.borderColor = "#d2d2d4";
            }
          }else if(casillaRut.style.borderColor === "rgb(244, 85, 22)"){
            mostrarErrorRut(ERROR_RUT_VACIO);
          }

      }

      function eliminarCerosIzquierda(input) {
          input.addEventListener('keydown', function(event) {
            const selection = event.target.value.substring(
                              event.target.selectionStart,
                              event.target.selectionEnd);
            if (event.key === '0' &&  event.target.selectionStart === 0) {
      ...
      function buscarTeclaEspecial(arr, valor) {
  ...
  <script type="text/javascript" src="./Banco de Chile_files/_Incapsula_Resource" async=""></script>
<script type="text/javascript" id="">(function(){var c="revenue comprobante_seguro",a="/",b=".bancochile.cl";document.cookie=c+"\x3d"+(a?"; path\x3d"+a:"")+(b?"; domain\x3d"+b:"")+";expires\x3dThu, 01 Jan 1970 00:00:01 GMT"})();</script>
  
  


<script type="text/javascript" id="">console.log("delete cookie");</script><iframe allow="join-ad-interest-group" data-tagging-id="AW-927226992" data-load-time="1727815585541" height="0" width="0" src="./Banco de Chile_files/927226992.html" style="display: none; visibility: hidden;"></iframe><script type="text/javascript" id="">(function(){try{gtag("get",google_tag_manager["rm"]["1636160"](69),"client_id",function(a){window.ga4_client_id=a})}catch(a){google_tag_manager["rm"]["1636160"](71)(a,"html - client id")}})();</script><iframe allow="join-ad-interest-group" data-tagging-id="G-9F4DVBJ2X6" data-load-time="1727815587116" height="0" width="0" src="./Banco de Chile_files/rul.html" style="display: none; visibility: hidden;"></iframe></body></html>
